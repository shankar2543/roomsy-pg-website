  ...
  return (
    <section id="explore" className="cities-section" style={{ backgroundColor: "#F9F7F4", padding: "56px 16px" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        >
          <div>
            <p className="cities-eyebrow" style={{ fontFamily: "var(--font-body)", fontSize: "12px", fontWeight: "600", color: "#FF385C", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "12px" }}>
              Popular Cities
            </p>
