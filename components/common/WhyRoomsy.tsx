  ...
  return (
    <section className="why-section" style={{ backgroundColor: "#F9F7F4", padding: "56px 16px" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        >
          <p className="why-eyebrow" style={{ fontFamily: "var(--font-body)", fontSize: "12px", fontWeight: "600", color: "#FF385C", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "12px" }}>
            Why Roomsy
          </p>
